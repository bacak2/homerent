...
if('ontouchstart'in window===false){toDayElement[i].onmouseover=function(e){if($(this).hasClass('t-special-day')===true&&$(this).parents('.t-datepicker-day').length!=0){$(this).parents('.t-datepicker-day')}
...
var getDays=Number(toDayElement[i].getAttribute('data-t-date'));var getMonths=new Date(getDays).getMonth()+1;var key=gYear+'-'+check_num_10(gMonth)+'-'+check_num_10(getNum);if(settings.fnDataEvent[key]!=undefined&&getMonths===m){var cln=toDayElement[i].className;toDayElement[i].className=toDayElement[i].className.replace(' t-special-day','')+' t-special-day';toDayElement[i].setAttribute('t-date-title',getNum+' '+settings.titleMonths[new Date(getDays).getMonth()]+' - '+settings.fnDataEvent[key])}if(settings.fnDataEvent2[key]!=undefined&&getMonths===m){var cln=toDayElement[i].className;toDayElement[i].className=toDayElement[i].className.replace(' t-special-day-second','')+' t-special-day-second';toDayElement[i].setAttribute('t-date-title',getNum+' '+settings.titleMonths[new Date(getDays).getMonth()]+' - '+settings.fnDataEvent2[key])}}}}}
...
if(jsCalendarLegend===true){$(pr_el).find('.t-dates').parent().append('<div class="t-datepicker-day'+checkNumCalendar+'">'+convertArrayToString(dataTheme)+'<div style="margin-left: auto" class="mt-2 mx-3"><span class="mr-4 d-inline-block" style="position: relative"><div id="detail-legend-av" class="detail-legend"></div><div class="" style="position: relative; top: -3px; left: 3px; display: inline-block">'+messagesAvailable+'</div></span><span class="mr-4 d-inline-block" style="position: relative"><div id="detail-legend-booked" class="detail-legend"></div><div class="" style="position: relative; top: -3px; left: 3px; display: inline-block">'+messagesOccupied+'</div></span><span class="d-inline-block" style="position: relative"><div id="detail-legend-pre-booked" class="detail-legend"></div><div class="" style="position: relative; top: -3px; left: 3px; display: inline-block">'+messagesPreliminary+'</div></span></div></div>')}
else{$(pr_el).find('.t-dates').parent().append('<div class="t-datepicker-day'+checkNumCalendar+'">'+convertArrayToString(dataTheme)+'</div>')}
