...
return [
    ...
    'Share your opinion' => 'Enjoy your stay and share your opinion',
    'objects2' => 'objects',
    ...
    'Account' => 'Account',
    'faqQ1' => 'How can i make a reservation?',
    'faqQ2' => 'How can I make a deposit?',
    ...
    'Rate now' => 'Rate now',
    'RateNow1' => 'Your rating and opinion help you choose others in the future.',
    'RateNow2' => 'And in addition, you get a 5% discount or 50 PLN discount on your next reservation.',
    ...
    'I accept the cookie policy' => 'I accept the cookies policy',
    'Walk 3d' => 'Walk 3d',
    'Remember' => 'Remember',
    'ThxMailContact' => 'Thank you for sending a message',
    'ThxMailContact2' => 'We will contact you as soon as possible.',
    'expires in' => 'expires in',
    'Search for reservation' => 'Search for reservation',
    'Reservation date' => 'Reservation date',
    'fexRes' => 'e.g.: reservation number, name / address of the object',
    'Change the search criteria' => 'Change the search criteria',
    'NullSearch' => 'No search results found for the given parameters',
    'travelers1' => 'Enter the location of the date, the number of travelers and choose apartments according to your criteria.',
    'travelers3' => 'Have you had great moments?',
    'travelers4' => 'Or maybe there is something we should do better?',
    'travelers5' => 'Share your impressions with others.',
    'aboutUs1' => 'OtoZakopane - is part of the Visit Group, which has existed for over 10 years and strives to be a leader on the short-term rental market in Zakopane and the surrounding area.',
    'aboutUs2' => 'We are a portal that offers the most attractive apartment offers in Zakopane, Kościelisko and Witów. Above all apartments, comprehensive and professional care. The whole team ensures that our guests feel at home when they arrive at the apartment.',
    'aboutUs3' => 'Thanks to trust and our commitment, we have over 38 thousand satisfied customers from Poland and abroad, and over 2777 guests have written opinions about their stay in Zakopane.',
    'Privacy policy of service' => 'OtoZakopane privacy policy',
    'TravelersInfo1' => 'Find the object that interests you, read the information about it. You can check what\'s in the area right away. Both thanks to the street view functionality, as well as a list of objects that are nearby (eg restaurants, shops or playgrounds). Come and enjoy your stay -',
