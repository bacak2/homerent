...
<div>
    <table>
        ...
        <tr><td>{{__('messages.MailContent2')}}</td></tr>
        ...
        <tr><td style="font-size: 11px">{{__('messages.Contact')}}: 22/565 66 66 ({{__('messages.monToFri')}} 9:00-17:00), <span style="color: #8fdf82">kontakt@visitzakopane.pl</span></td></tr>
        <tr><td><hr style="border: 0 none;  border-top: 2px dashed black;  background: none;"></td></tr>
