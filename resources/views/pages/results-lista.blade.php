		...
		<div class="row">
                    <div class="col-3 col-sm-6 col-md-4 col-lg-3 col-xl-3">
                        <a href="/apartaments/{{ $apartament->apartament_link }}">
                            <img style="height: auto; max-width: 280px;" src="{{ asset("images/apartaments/$apartament->id/1.jpg") }}">
                        </a>
                    </div>
                    ...
                    <div class="col-2">
                        ...
                        <div class="row">
                            <div class="container py-1" ><a href="{{ url()->previous() }}" class="btn btn-primary ml-2" style="width: 100%">{{ __('messages.book') }}</a></div>
                        </div>
                        <div class="row">
                            <div class="container py-1" ><a href="{{ url()->previous() }}" class="btn btn-primary ml-2" style="width: 100%">{{ __('messages.see details') }}</a></div>
                        </div>
                    </div>
		</div>
            @endforeach
