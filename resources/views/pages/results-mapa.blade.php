		...
		function mapaStart()
		{
            ...
            mapa = new google.maps.Map(document.getElementById("mapka"), opcjeMapy);
                        ...
                        @foreach ($gray as $apartament)
                            var marker3 = dodajSzaryMarker( {{ $apartament->apartament_geo_lat }}, {{ $apartament->apartament_geo_lan }},'<div class="map-img-wrapper greenIcon"><a class="d-xl-none px-0" href="/apartaments/{{ $apartament->apartament_link }}?{{ http_build_query(Request::except("page", "region")) }}?{{ http_build_query(Request::except("page", "region")) }}"><img style="width: 210px; height: 112px"src="{{ asset("images/apartaments/$apartament->id/1.jpg") }}"></a><img class="d-none d-xl-block" style="width: 300px; height: 169px"src="{{ asset("images/apartaments/$apartament->id/1.jpg") }}"><div class="map-see-more"><div class="container py-1"><a href="/apartaments/{{ $apartament->apartament_link }}?{{ http_build_query(Request::except("page", "region")) }}" style="width: 100%" class="btn btn-primary d-none d-xl-block">{{ __("messages.book") }}</a></div><div class="container py-1"><a href="/apartaments/{{ $apartament->apartament_link }}?{{ http_build_query(Request::except("page", "region")) }}" class="btn btn-see-more d-none d-xl-block"" style="width: 100%">{{ __("messages.see details") }}</a></div></div><div class="map-description-top">199 PLN</div> <div class="map-description-bottom">{{ __("messages.Breakfast included") }}</div><div class="add-to-favourities"><span data-toggle="tooltip" data-placement="bottom" title="{{ __('messages.Add to favorites') }}" onClick="addToFavourites({{$apartament->id}}, {{Auth::user()->id ?? 0}})"><img src="{{ asset('images/results/heart.png') }}"></span></div></div><span class="map-description"><span style="font-size: 17px; display: inline-block">{{ $apartament->apartament_name }}</span><br> <span style="font-size: 11px; display: inline-block">{{ $apartament->apartament_district }}</span><br> <span style="font-size: 11px; display: inline-block">{{ $apartament->apartament_address }}</span><div><div class="description-below-img" data-toggle="tooltip" data-placement="bottom" title="{{ __('messages.Number of') }} {{ __('messages.people') }}" style="background-image: url({{ asset('images/results/person.png') }})"> <span>{{ $apartament->apartament_persons }}</span></div><div class="description-below-img desktop-none" data-toggle="tooltip" data-placement="bottom" title="{{ __('messages.Number of') }} {{ __('messages.kids') }}" style="background-image: url({{ asset('images/results/child.png') }})"> <span>{{ $apartament->apartament_persons }}</span></div><div class="description-below-img mobile-none" data-toggle="tooltip" data-placement="bottom" title="{{ __('messages.Number of') }} {{ __('messages.double beds') }}" style="background-image: url({{ asset("images/results/doubleBed.png") }});"><span>{{ $apartament->apartament_double_beds }}</span></div><div class="description-below-img" data-toggle="tooltip" data-placement="bottom" title="{{ __('messages.Number of') }} {{ __('messages.single beds') }}" style="background-image: url({{ asset("images/results/bed.png") }});"><span>{{ $apartament->apartament_single_beds }}</span></div>@if($apartament->ratingAvg < 4.5)<div class="description-below-img d-xl-none note" style="background-color: red"><span>{{number_format($apartament->ratingAvg, 1, ",", "")}}</span></div>@elseif($apartament->ratingAvg < 6.5)<div class="description-below-img d-xl-none note" style="background-color: yellow;"><span style="color: black">{{number_format($apartament->ratingAvg, 1, ",", "")}}</span></div>@else<div class="description-below-img d-xl-none note" style="background-color: green"><span>{{number_format($apartament->ratingAvg, 1, ",", "")}}}</span></div>@endif<div class="d-xl-none description-below-notes">({{$apartament->opinionAmount ?? 0}} {{trans_choice("messages.nrReviews", $apartament->opinionAmount ?? 0)}})</div>@if ( $apartament->apartament_wifi == 1)<div class="description-below-img d-none d-xl-inline-block" data-toggle="tooltip" data-placement="bottom" title="Wifi" style="background-image: url({{ asset("images/results/wifi.png") }});"></div>@endif @if ( $apartament->apartament_parking == 1) <div class="description-below-img d-none d-xl-inline-block" data-toggle="tooltip" data-placement="bottom" title="Parking" style="background-image: url({{ asset("images/results/parking.png") }});"> </div> @endif</div><div class="description-map-bottom-right d-none d-xl-block">@for ($i = 0; $i < floor($apartament->ratingAvg/2); $i++)<img src="{{ asset("images/results/star.png") }}">@endfor @if(floor($apartament->ratingAvg/2) != ceil($apartament->ratingAvg/2))<img src="{{ asset("images/results/star_half.png") }}">@endif @for ($i = ceil($apartament->ratingAvg/2); $i < 5; $i++)<img src="{{ asset("images/results/star_empty.png") }}">@endfor<br>@if($apartament->ratingAvg < 1)<span class="opinion-to-left" style="margin-right: 10px;"></span>@elseif($apartament->ratingAvg < 2.5)<span class="opinion-to-left txt-red" style="margin-right: 10px;">{{ __("messages.Awful") }}</span>@elseif($apartament->ratingAvg < 4.5)<span class="opinion-to-left txt-red" style="margin-right: 10px;">{{ __("messages.Bad") }}</span>@elseif($apartament->ratingAvg < 6.5)<span class="opinion-to-left txt-yellow" style="margin-right: 10px;">{{ __("messages.Average") }}</span>@elseif($apartament->ratingAvg < 8.5)<span class="opinion-to-left txt-green" style="margin-right: 10px;">{{ __("messages.Very good") }}</span>@else<span class="opinion-to-left txt-green" style="margin-right: 10px;">{{ __("messages.Perfect") }}</span>@endif<span class="txt-blue nr-reviews-right">{{$apartament->opinionAmount ?? 0}} {{trans_choice("messages.nrReviews", $apartament->opinionAmount ?? 0)}}</span></div></span>', grayIcon);
                            @mobile
