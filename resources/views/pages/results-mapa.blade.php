...
@section ('displayResults')
            <div class="row desktop-none" style="margin-bottom: 20px">
                <div class="col-9 text-mobile-search">
                    <a href="/" style="color: #00afea">Start > </a><b>{{ $finds[0]->apartament_city ?? ''}}</b>, {{__('messages.from')}} {{ $_GET['t-start'] }}, {{__('messages.number of nights')}}: {{ $nightsCounter }}, {{__('messages.Persons')}}: {{ $_GET['dorosli']+$_GET['dzieci'] }}, {{__('messages.Filters')}}:
                </div>
                <div class="col-3">
